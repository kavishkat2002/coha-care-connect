...
import { n as createCsrfMiddleware, o as __exportAll } from "./server-BBwoW3Vo.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-rU8DPIYI.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bv4bCY6n.mjs").then((n) => n.t),
