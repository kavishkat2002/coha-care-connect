...
import { n as createCsrfMiddleware, o as __exportAll } from "./server-IqVcekK3.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Ro__EIIV.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BeGuFIDc.mjs").then((n) => n.t),
