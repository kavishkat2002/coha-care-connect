...
import { n as createCsrfMiddleware, o as __exportAll } from "./server-DlLVIWDa.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DkYUSC5L.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BJnJxs0o.mjs").then((n) => n.t),
