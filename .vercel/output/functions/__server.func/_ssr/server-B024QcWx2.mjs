...
import { n as createCsrfMiddleware, o as __exportAll } from "./server-B024QcWx.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BTJVmtCc.mjs");
...
var manifest = {
	"0089292b98181cd7dbfe5e8fbca3a6a3dc29bf87ad599183c4c0a889188688d4": {
		functionName: "updateServerProfile_createServerFn_handler",
		importer: () => import("./profile.server-kgiHhtll.mjs")
	},
	"87ece0118feb81ffcebb1e76c3d745627d89c53ae28ed207ce312d19d9344727": {
		functionName: "fetchProfileServer_createServerFn_handler",
		importer: () => import("./api.profile-CO9WN5hT.mjs")
	},
	"a842eda2cee2fd9da27026f17f67c2340d86ebad4d44aaa9b9b3c4b09f4d3d00": {
		functionName: "fetchServerProfile_createServerFn_handler",
		importer: () => import("./profile.server-kgiHhtll.mjs")
	},
	"f2ad9920ba57fb9ca49cbffd8f8e0244c86636432c3ab611909798c1f1e437c8": {
		functionName: "updateProfileServer_createServerFn_handler",
		importer: () => import("./api.profile-CO9WN5hT.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-zJX37N7C.mjs").then((n) => n.t),
