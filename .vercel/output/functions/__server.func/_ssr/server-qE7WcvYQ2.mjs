...
import { n as createCsrfMiddleware, o as __exportAll } from "./server-qE7WcvYQ.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D9Fg4fWX.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BNCUifkZ.mjs").then((n) => n.t),
